...
<body>
    ...
    <div class="container">
      <div class="homeCont twelve columns">
        ...
        <p>Effortless, elegant, individual.The life that awaits at The Centrale.
        Dolorem molestias tempora reiciendis libero, sunt ex enim ipsam beatae
        voluptatum consectetur facere nesciunt maxime fuga provident.</p>
      </div>
      </div>
    ...
    <a href="unit.php">
    <img src="imgs/unit1.jpg" alt="unit1 ">
    </a>
            
    <a href="unit.php">
    <img src="imgs/unit2.jpg" alt="unit2 ">
    </a>
            
    <a href="unit.php">
    <img src="imgs/unit3.jpg" alt="unit3 ">
    </a>
             
    <a href="unit.php">
    <img src="imgs/unit4.jpg" alt="unit4">
    </a>
    ...
    <a class="button" href="unit.php"> More </a>
    </div>
    </div>
